...
// const MenuWithUnderline = ({ pages, textColor, displayStyle }: Props) => {
//     const [selectedPage, setSelectedPage] = useState<string | null>(null)
//     const theme = useTheme()

//     // Usar el displayStyle proporcionado o el valor por defecto
//     const display = displayStyle || { xs: "none", md: "flex" }
...
//                             boxShadow: "none",
//                             "&:hover": {
//                                 backgroundColor: "transparent !important", // Anula el fondo en hover
//                                 boxShadow: "none !important", // Anula la sombra en hover definida en tu tema
//                             },
//                             "&::after": {
//                                 content: '""',
//                                 position: "absolute",
