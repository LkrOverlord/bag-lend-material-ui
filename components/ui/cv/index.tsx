...
//     "Material UI", "Ant Design", "Git", "Jest", "Java", "QA Testing", "Playwright"
//   ];
...
//                   <Link href="mailto:menesestapia@gmail.com" color="inherit" sx={{ color: "primary.light", textDecoration: 'underline' }}>
//                     menesestapia@gmail.com
//                   </Link>
//                 </ListItem>
//                 <ListItem sx={{ p: 0, flexDirection: 'column', alignItems: 'flex-start' }}>
//                   <Typography variant="body2" fontWeight="bold">Teléfono:</Typography>
...
//                 Desarrollador Frontend con especialización en React y experiencia en QA Testing.
//                 Apasionado por crear interfaces de usuario atractivas y funcionales.
//                 Enfocado en escribir código limpio y mantenible, con habilidades para trabajar
//                 en equipo y adaptarme rápidamente a nuevas tecnologías.
//               </Typography>
//             </Box>
...
//                 </Typography>
//                 <Typography variant="body2" color="text.secondary">2020 - 2024</Typography>
//               </Box>
